...
import { reorderByIndex } from './archiveSort';
...
export const useArchiveFilter = (
    ...
    } = useArchiveViewState({ citations, authors, authorFolders, authorFolderMemberships, books, projects, username, ownerKey: userId, dataReady });
